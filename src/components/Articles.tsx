      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl z-10">
        ...
        >
          ...
          <div className={textClass} itemProp="articleBody">
            ...
            {/* ── Article 1 CTA Block ── */}
            <div className={`mt-8 pt-6 border-t ${dk ? 'border-gray-700' : 'border-gray-200'}`}>
              <p className={`text-sm font-semibold mb-4 uppercase tracking-wide ${dk ? 'text-gray-400' : 'text-gray-500'}`}>
                Enjoyed this article?
              </p>
              <div className="flex flex-wrap gap-3">
                <a href="#projects" aria-label="See Purva Monga's machine learning projects"
                  className={`inline-flex items-center gap-2 px-4 py-2 text-sm font-semibold rounded-lg border transition-all ${dk ? 'border-blue-500 text-blue-400 hover:bg-blue-900/30' : 'border-blue-600 text-blue-700 hover:bg-blue-50'}`}>
                  📁 See My Projects
                </a>
                <a href="#articles" aria-label="Read Article 2 about deep learning vs machine learning"
                  className={`inline-flex items-center gap-2 px-4 py-2 text-sm font-semibold rounded-lg border transition-all ${dk ? 'border-gray-600 text-gray-300 hover:bg-gray-800' : 'border-gray-400 text-gray-700 hover:bg-gray-100'}`}>
                  ➡ Read Article 2
                </a>
                <a href="https://linkedin.com/in/purvamonga" target="_blank" rel="noopener noreferrer"
                  aria-label="Connect with Purva Monga on LinkedIn"
                  className="inline-flex items-center gap-2 px-4 py-2 text-sm font-semibold rounded-lg bg-[#0077B5] text-white hover:bg-[#006097] transition-all">
                  <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433a2.062 2.062 0 0 1-2.063-2.065 2.064 2.064 0 1 1 2.063 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/></svg>
                  Connect on LinkedIn
                </a>
                <a href="/Purva(ML)_Samsung.pdf" target="_blank" rel="noopener noreferrer"
                  aria-label="Download Purva Monga's Machine Learning Resume"
                  className={`inline-flex items-center gap-2 px-4 py-2 text-sm font-semibold rounded-lg border transition-all ${dk ? 'border-stone-400 text-stone-300 hover:bg-stone-800' : 'border-gray-700 text-gray-800 hover:bg-gray-100'}`}>
                  📄 View Resume
                </a>
              </div>
            </div>
        ...
        >
          ...
          <div className={textClass} itemProp="articleBody">
            ...
            <div className={`mt-8 pt-6 border-t ${dk ? 'border-gray-700' : 'border-gray-200'}`}>
              ...
              <div className="flex flex-wrap gap-3">
                <a href="#projects" aria-label="See Purva Monga's ML and AI projects"
                  className={`inline-flex items-center gap-2 px-4 py-2 text-sm font-semibold rounded-lg border transition-all ${dk ? 'border-blue-500 text-blue-400 hover:bg-blue-900/30' : 'border-blue-600 text-blue-700 hover:bg-blue-50'}`}>
                  📁 See My ML Projects
                </a>
                <a href="#experience" aria-label="See Purva Monga's Samsung PRISM internship"
                  className={`inline-flex items-center gap-2 px-4 py-2 text-sm font-semibold rounded-lg border transition-all ${dk ? 'border-gray-600 text-gray-300 hover:bg-gray-800' : 'border-gray-400 text-gray-700 hover:bg-gray-100'}`}>
